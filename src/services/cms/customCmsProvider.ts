...
function mapAuthor(raw: any): CMSAuthor {
  return {
    ...
    email: raw.email || '',
    avatar: raw.avatarUrl || raw.avatar || raw.coverImageUrl || '',
    coverImage: raw.coverImageUrl || raw.coverImage || '',
    bio: raw.bio || '',
    bioHindi: raw.bioHindi || '',
    shortBio: raw.shortBio || '',
    designation: raw.designation || '',
    profession: raw.profession || '',
    otherRoles: raw.otherRoles || '',
    ...
    knowsAbout: raw.knowsAbout || undefined,
